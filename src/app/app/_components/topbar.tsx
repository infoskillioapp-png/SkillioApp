    ...
    <header className="flex items-center justify-between px-5 sm:px-6 bg-bg border-b border-rule transition-colors">
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          className="flex items-center justify-center w-8 h-8 rounded-full border border-rule-soft hover:border-[#25D366] hover:text-[#25D366] transition text-ink-soft"
