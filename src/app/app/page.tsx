...
function DashboardContinuar({ lastOutput }: { lastOutput: AiOutputRow | null }) {
  const cardStyle: React.CSSProperties = {
    ...
    color: "#fff",
    borderRadius: 28,
    boxShadow: "0 12px 32px rgba(63,99,255,.40)",
    ...
    <div style={cardStyle}>
      ...
      <Link
        ...
        style={{
          ...
          color: "var(--v3-blue)", fontFamily: "var(--v3-po)", fontWeight: 700, fontSize: 14.5,
          background: "#fff", boxShadow: "0 8px 20px rgba(0,0,0,.15)",
          textDecoration: "none",
        }}
      >
    ...
    <section>
          ...
          <div style={{ textAlign: "center", padding: "52px 24px 44px", display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
            ...
            <Link
              ...
              style={{
                ...
                background: "linear-gradient(135deg,#4f7dff,#8b5cf6)",
                boxShadow: "0 12px 24px rgba(99,102,241,.32)",
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  padding: "15px 14px",
                  borderBottom: i < subjects.length - 1 ? "1px solid #eef0f6" : "none",
                  textDecoration: "none", color: "inherit",
                  borderRadius: 16, transition: "background .16s",
                }}
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontFamily: "var(--v3-po)", fontWeight: 700, fontSize: 16, color: "var(--v3-ink)" }}>
                    {s.name}
                  </div>
                  {s.professor && (
                    <div style={{ fontSize: 12.5, color: "var(--v3-muted)", marginTop: 1 }}>{s.professor}</div>
                  )}
                </div>
                <div style={{ color: "var(--v3-faint)" }}>
      ...
      <Link
        ...
        style={{
          ...
          border: "2px dashed #d6d9ec", borderRadius: 18,
          color: "var(--v3-muted)", fontWeight: 600, fontSize: 13.5,
          textDecoration: "none", transition: ".2s",
        }}
        onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#8b5cf6"; e.currentTarget.style.color = "#8b5cf6"; }}
        onMouseLeave={(e) => { e.currentTarget.style.borderColor = "#d6d9ec"; e.currentTarget.style.color = "var(--v3-muted)"; }}
      >
        <div style={{
          width: 40, height: 40, borderRadius: 13,
          background: "#eef0ff", color: "#8b5cf6",
